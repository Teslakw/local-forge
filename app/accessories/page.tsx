...
export const ACCESSORIES_DATA = [
    ...
    { id: 9, name: 'Batik Mega Mendung Tank Cover', price: 2800000, priceDisplay: 'Rp 2.800.000', image: 'https://i.ibb.co/0V8CYK1w/Gemini-Generated-Image-19a66319a66319a6.png', type: 'Seni Lokal', rating: 5, desc: 'Handcrafted tank cover dengan motif Batik Mega Mendung dari Cirebon. Dibuat manual oleh pengrajin lokal.' },
    { id: 10, name: 'Ukiran Bali Custom Dashboard', price: 8500000, priceDisplay: 'Rp 8.500.000', image: 'https://i.ibb.co/KkHZR8b/Gemini-Generated-Image-pffg5pffg5pffg5p.png', type: 'Seni Lokal', rating: 5, desc: 'Dashboard kayu dengan ukiran khas Bali. Motif Barong dan flora tradisional yang dikerjakan oleh maestro ukir Gianyar.' },
    { id: 11, name: 'Tenun Toraja Seat Cover Set', price: 4500000, priceDisplay: 'Rp 4.500.000', image: 'https://i.ibb.co/zh0vsJXY/Gemini-Generated-Image-j5ahc8j5ahc8j5ah.png', type: 'Seni Lokal', rating: 5, desc: 'Set jok dengan motif Tenun Toraja asli. Dibuat dari bahan tenun tradisional Sulawesi Selatan.' },
    { id: 12, name: 'Wayang Kulit Gear Shift Knob', price: 1500000, priceDisplay: 'Rp 1.500.000', image: 'https://i.ibb.co/1fMjczZt/Gemini-Generated-Image-te8mbete8mbete8m.png', type: 'Seni Lokal', rating: 4, desc: 'Knob persneling dengan desain Wayang Kulit. Ukiran tangan dari kulit sapi asli dengan motif Punakawan.' },
    ...
    { id: 14, name: 'Songket Palembang Interior Trim', price: 6200000, priceDisplay: 'Rp 6.200.000', image: 'https://i.ibb.co/274j9PBK/Gemini-Generated-Image-26bgen26bgen26bg.png', type: 'Seni Lokal', rating: 5, desc: 'Trim interior dengan kain Songket Palembang asli berbenang emas. Elegan dan eksklusif.' },
    { id: 15, name: 'Reog Ponorogo Mirror Decals', price: 650000, priceDisplay: 'Rp 650.000', image: 'https://i.ibb.co/Df5GC1xb/Gemini-Generated-Image-3takwz3takwz3tak.png', type: 'Seni Lokal', rating: 4, desc: 'Stiker spion dengan ilustrasi Singa Barong dari kesenian Reog Ponorogo. Vinyl premium.' },
    { id: 16, name: 'Keris Jawa Exhaust Tip', price: 3800000, priceDisplay: 'Rp 3.800.000', image: 'https://i.ibb.co/1G0YdRGS/Gemini-Generated-Image-8wzkrv8wzkrv8wzk.png', type: 'Seni Lokal', rating: 5, desc: 'Tip knalpot stainless steel dengan desain bilah Keris. CNC machined dengan finishing chrome atau black.' },
    { id: 17, name: 'Ondel-Ondel Bobblehead Set', price: 450000, priceDisplay: 'Rp 450.000', image: 'https://i.ibb.co/1fBb9J90/Gemini-Generated-Image-wqsozbwqsozbwqso.png', type: 'Seni Lokal', rating: 4, desc: 'Set boneka Ondel-Ondel Betawi untuk dashboard. Handmade dari resin dengan detail lukis tangan.' },
